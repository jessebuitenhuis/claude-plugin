...
### 4. Self-Verify
Run all tests, check code quality, verify acceptance criteria.
...
Always invoke via Task tool as a subagent:
```
Task with subagent_type="general-purpose", prompt="use implementator skill: <task>"
```
